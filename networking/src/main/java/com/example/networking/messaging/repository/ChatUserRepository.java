...
public interface ChatUserRepository extends JpaRepository<ChatUser, ChatUserId> {
    ...
    List<ChatUser> findByChatRoomIdAndIsActiveTrue(Long chatRoomId);
    Optional<ChatUser> findByChatRoomIdAndUserIdAndIsActiveTrue(Long chatRoomId, Integer userId);
